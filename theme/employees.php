	...
	<div class="row">
	    ...
	    <div class="col-md-6">
	    	<ul class="action-btns pull-right">
	    		<li>
	    			<button type="button" class="btn btn-icon btn-primary open-modal"><i class="bx bx-plus"></i></button>
	    		</li>
	    		 
	    		<li>
	    			<button type="button" class="btn btn-icon btn-info" title="Import Records"><i class="bx bx-upload"></i></button>
	    		</li>
	    		<li>
			...
			<div class="col-12 page-data">
			  ...
			  <div class="pagination-wrapper row">
			  	...
			  	<div class="col-md-6">
		              ...
		              <ul class="pagination  pull-right mt-1 mr-3">
