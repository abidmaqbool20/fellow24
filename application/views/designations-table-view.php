	...
	<div class="row">
		...
		<div class="col-md-6">
			<ul class="action-btns default-actions pull-right">
				...
				<li>
					<button type="button" class="btn btn-icon btn-theme open-model"  data="<?php echo get_json(array('id'=>'0','view'=>'models/form-designation')); ?>"><i class="bx bx-plus"></i></button>
				</li>
				<li>
				...
				<li>
					<button type="button" class="btn btn-icon btn-danger reload-page load-view" data="<?php echo get_json(array('id'=>'0','view'=>'designations-table-view','type'=>'table')); ?>"  title="Refresh Page"><i class="bx bx-refresh"></i></button>
				</li>
				<li>
					<div class="btn-group" role="group" aria-label="Basic example">
						<button type="button" data="<?php echo get_json(array('id'=>'0','view'=>'designations-table-view','type'=>'table')); ?>" class="btn active load-view"><i class="bx bx-table"></i></button>
						<button type="button" data="<?php echo get_json(array('id'=>'0','view'=>'designations-card-view','type'=>'card')); ?>" class="btn load-view"><i class="bx bxs-widget"></i></button>
					</div>
				</li>	 
			</ul>
			<ul class="action-btns selected-actions pull-right hide"> 
				...
				<li>
					...
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="tag">
						<a href="javascript:;" class="dropdown-item align-items-center export-all-data " function="export_all_designations">
							<span class="bullet bullet-success bullet-sm"></span>
							<span> &nbsp;Export All</span>
						</a>
						<a href="javascript:;" function="export_designations" class="dropdown-item align-items-center export-data">
							<span class="bullet bullet-success bullet-sm"></span>
							<span> &nbsp;Export Selected Only</span>
						</a>
						<a href="javascript:;" parent-div="table-records" table="designations" class="dropdown-item align-items-center delete-bulk">
		...
		<div class="row">
				...
				<div class="table-view">
					<div class="table-responsive">
						<table class="table table-hover mb-0 page-table" id="table-sortable">
								...
								<tr> 
									<th class="table-checkbox table_record_checkbox"> 
										<div class="checkbox theme-checkbox ">
											<input type="checkbox" id="colorCheckbox0" class="table_head_checkbox" table="designations"> 
											<label for="colorCheckbox0"></label>
										</div>
									</th>
									<th class="col-title">Title <i class="bx bx-sort"></i></th>
									<th class="col-job_nature">JOB Nature <i class="bx bx-sort"></i></th>
									<th class="col-pay_scale">Pay-Scale <i class="bx bx-sort"></i></th>
									<th class="col-file hide">File <i class="bx bx-sort"></i></th>
							...
							<tbody class="designations table-records">     	
							</tbody>
						</table>
					</div> 
				</div>
			...
			<div class="col-3 filter-sidebar page-sidebar hide">
				<div class="filter-side-content">
					<div class="card shadow-none quill-wrapper">
						...
						<!-- form start -->
						<form method="post" autocomplete="off" action="<?= base_url('App/filter_designations'); ?>" enctype="multipart/form-data" class="filter-records">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<fieldset class="form-group">
												...
												<input type="text" class="form-control filter-text-field" id="basicInput" placeholder="Enter Title" name="name">
											</fieldset>

											<fieldset class="form-group">
												<label for="description-for">Job Nature</label>
												<select class="form-control select2 filter-dropdown" name="job_nature_id" id="job_nature_id">
											...
											<fieldset class="form-group">
												<label for="description-for">Pay-Scale</label>
												<select class="form-control select2 filter-dropdown" name="scale_id" id="scale_id">
													<option value="">Select</option>
													<?php
													$records = $this->App_Model->get_pay_scales(); 
													if($records->num_rows() > 0){
														foreach ($records->result() as $key => $value) {
															echo '<option value="'.$value->id.'">'.$value->name.'</option>';
														}
								...
								<div class="card-body">
									...
									<div class="col-12">
										<div class="row">
											...
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" checked="checked" value="job_nature" id="tbl-col-checkbox-2" name ="tbl-col-checkbox-2"> 
													<label for="tbl-col-checkbox-2">Job Nature</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" checked="checked" value="pay_scale" id="tbl-col-checkbox-3" name ="tbl-col-checkbox-3"> 
													<label for="tbl-col-checkbox-3">Pay-Scale</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column"  value="file" id="tbl-col-checkbox-4" name ="tbl-col-checkbox-4"> 
													<label for="tbl-col-checkbox-4">File</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" value="description" id="tbl-col-checkbox-5" name ="tbl-col-checkbox-5"> 
													<label for="tbl-col-checkbox-5">Description</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" checked="checked" value="status" id="tbl-col-checkbox-6" name ="tbl-col-checkbox-3"> 
													<label for="tbl-col-checkbox-6">Status</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" value="added_by" id="tbl-col-checkbox-7" name ="tbl-col-checkbox-4"> 
													<label for="tbl-col-checkbox-7">Added By</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" value="modified_by" id="tbl-col-checkbox-8" name ="tbl-col-checkbox-5"> 
													<label for="tbl-col-checkbox-8">Modified By</label>
												</div>
											</div>

											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" checked="checked" value="date_added" id="tbl-col-checkbox-9" name ="tbl-col-checkbox-6"> 
													<label for="tbl-col-checkbox-9">Date Added</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" value="date_modification" id="tbl-col-checkbox-10" name ="tbl-col-checkbox-7"> 
													<label for="tbl-col-checkbox-10">Date Modification</label>
												</div>
											</div>
										</div>
									</div>
			...
			<div class="col-3 import-records-sidebar page-sidebar hide">
				<div class="filter-side-content">
					<div class="card shadow-none quill-wrapper">
						<div class="card-header d-flex justify-content-between align-items-center border-bottom px-2 py-1">
							<h3 class="card-title">Import designations </h3>
							<button type="button" class="close close-icon page-sidebar-close">
								<i class="bx bx-x"></i>
							</button>
						</div>
						<!-- form start -->
						<form method="post" autocomplete="off" action="<?= base_url('App/import_designation_csv_file'); ?>" enctype="multipart/form-data" class="import-csv-form">
							<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
							<input type="hidden" name="per_page" id="per_page" value="10" class="per_page">
							<div class="card-content">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-12">
											...
											<fieldset style="text-align: center" class="form-group">
												<button type="button" class="btn btn-theme btn-sm sample-import-file" target="designations.csv"><i class="bx bx-cloud-download"></i> Download Sample</button>
											</fieldset>
										</div>
									</div>
								</div>
