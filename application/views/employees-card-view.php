	...
	<div class="row">
				...
				<div class="col-12">
					...
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb p-0 mb-0"> 
							...
							<li class="breadcrumb-item active">All Employees Cards </li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="col-md-6">
			<ul class="action-btns default-actions pull-right">
				...
				<li>
					<button type="button" class="btn btn-icon btn-danger reload-page load-view" data="<?php echo get_json(array('id'=>'0','view'=>'employees-card-view','type'=>'card')); ?>"  title="Refresh Page"><i class="bx bx-refresh"></i></button>
				</li> 
				<li>
					<div class="btn-group" role="group" aria-label="Basic example">
						<button type="button" data="<?php echo get_json(array('id'=>'0','view'=>'employees-table-view','type'=>'table')); ?>" class="btn load-view"><i class="bx bx-table"></i></button>
						<button type="button" data="<?php echo get_json(array('id'=>'0','view'=>'employees-card-view','type'=>'card')); ?>" class="btn active  load-view"><i class="bx bxs-widget"></i></button>
					</div>
				</li>	 
			</ul>
				...
				<div class="card-view table-responsive">
					<div class="">
						<div class="card-deck-wrapper">
					        <div class="card-deck">
					          	<div class="row no-gutters employees table-records">
