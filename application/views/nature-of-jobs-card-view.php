	...
	<div class="row">
				...
				<div class="col-12">
					...
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb p-0 mb-0"> 
							...
							<li class="breadcrumb-item active">All Nature Of Jobs Cards </li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="col-md-6">
			<ul class="action-btns default-actions pull-right">
				...
				<li>
					<button type="button" class="btn btn-icon btn-danger reload-page load-view" data="<?php echo get_json(array('id'=>'0','view'=>'nature-of-jobs-card-view','type'=>'card')); ?>"  title="Refresh Page"><i class="bx bx-refresh"></i></button>
				</li> 
				<li>
					<div class="btn-group" role="group" aria-label="Basic example">
						<button type="button" data="<?php echo get_json(array('id'=>'0','view'=>'nature-of-jobs-table-view','type'=>'table')); ?>" class="btn load-view"><i class="bx bx-table"></i></button>
						<button type="button" data="<?php echo get_json(array('id'=>'0','view'=>'nature-of-jobs-card-view','type'=>'card')); ?>" class="btn active  load-view"><i class="bx bxs-widget"></i></button>
					</div>
				</li>	 
			</ul>
				...
				<div class="card-view table-responsive">
					<div class="">
						<div class="card-deck-wrapper">
					        <div class="card-deck">
					          <div class="row no-gutters nature_of_jobs table-records">
					          </div>
					        </div>
					    </div>
					</div> 
			...
			<div class="col-3 import-records-sidebar page-sidebar hide">
				<div class="filter-side-content">
					<div class="card shadow-none quill-wrapper">
						...
						<!-- form start -->
						<form method="post" autocomplete="off" action="<?= base_url('App/import_nature_of_jobs_csv_file'); ?>" enctype="multipart/form-data" class="import-csv-form">
							<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
							<input type="hidden" name="per_page" id="per_page" value="10" class="per_page">
							<div class="card-content">
								<div class="card-body">
