<?php
if (isset($id) && $id > 0) {
  $record = $this->App_Model->get_designation_rec($id);
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                      <div class="form-group">
                        ...
                        <select class="form-control select2 " required="required" name="payscale_id" id="payscale_id">
                          <option value="">Select</option>
                          <?php
                          if(isset($id)){
                                $pay_scales = $this->App_Model->get_payscales(); 
                                if($pay_scales->num_rows() > 0){
                                   foreach ($pay_scales->result() as $key => $value) {
                                      $selected = "";
                                      if(isset($record_data)){
                                         if($value->id == $record_data->payscale_id){ $selected = 'selected="selected"'; }
                                      }
