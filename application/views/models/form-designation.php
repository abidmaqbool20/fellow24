<?php
if (isset($id) && $id > 0) {
  $record = $this->App_Model->get_designations_rec($id);
            ...
            <div class="row">
              <div class="col-md-6 col-lg-6 col-sm-12">
                <div class="form-group">
                  <label class="form-label"><span class="required-label">*</span>Designation Title</label>
              ...
              <div class="col-md-6 col-lg-6 col-sm-12">
                <div class="form-group">
                  ...
                  <select name="scale_id" id="scale_id " class="form-control required select2" required="required">
                    <option value="">Select Scale</option>
                    <?php  
                      $pay_scales = $this->App_Model->get_pay_scales();
                      if ($pay_scales->num_rows() > 0) {
                        foreach($pay_scales->result() as $key => $value){
                          if (isset($record_data)) {
                            $selected = "";
                            if($record_data->scale_id == $value->id){
              ...
              <div class="col-md-6 col-lg-6 col-sm-12">
                <div class="form-group">
                  ...
                  <select name="job_nature_id" id="job_nature_id " class="form-control required select2" required="required">
                    <option value="">Select JOB</option>
                    <?php  
                      $nature_of_jobs = $this->App_Model->get_nature_of_jobs();
                      if ($nature_of_jobs->num_rows() > 0) {
                        foreach($nature_of_jobs->result() as $key => $value){
                          if (isset($record_data)) {
                            $selected = "";
                            if($record_data->job_nature_id == $value->id){
                              $selected = "selected='selected'";
                            }
                          }
                          echo '<option value="'.$value->id.'" '.$selected.'>'.$value->name.'</option>';
              ...
              <div class="col-md-6 col-lg-6 col-sm-12">
                <div class="form-group">
                  <label class="form-label"><span class="required-label">*</span>Designation File</label>
