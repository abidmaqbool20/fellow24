<?php
if (isset($id) && $id > 0) {
  $record = $this->App_Model->get_department_rec($id);
            ...
            <div class="row">
              <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="form-group">
                  <label class="form-label"><span class="required-label">*</span>Department Title</label>
               ...
               <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="form-group">
                  <label class="form-label"><span class="required-label">*</span>Short Name</label>
