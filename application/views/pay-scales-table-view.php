	...
	<div class="row">
		<div class="col-md-6">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h5 class="content-header-title float-left pr-1 mb-0"><i class="bx bxs-group"></i>&nbsp;Pay-Scales</h5>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb p-0 mb-0"> 
							<li class="breadcrumb-item"><a href="javascript:;">Home</a> </li>
							<li class="breadcrumb-item"> <i class="bx bx-chevrons-right">  </i> </li> 
							<li class="breadcrumb-item active">All Pay Scales </li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="col-md-6">
			<ul class="action-btns default-actions pull-right">
				...
				<li>
					<button type="button" class="btn btn-icon btn-danger reload-page load-view" data="<?php echo get_json(array('id'=>'0','view'=>'pay-scales-table-view','type'=>'table')); ?>"  title="Refresh Page"><i class="bx bx-refresh"></i></button>
				</li>
				<li>
					<div class="btn-group" role="group" aria-label="Basic example">
						<button type="button" data="<?php echo get_json(array('id'=>'0','view'=>'pay-scales-table-view','type'=>'table')); ?>" class="btn active load-view"><i class="bx bx-table"></i></button>
						<button type="button" data="<?php echo get_json(array('id'=>'0','view'=>'pay-scales-card-view','type'=>'card')); ?>" class="btn load-view"><i class="bx bxs-widget"></i></button>
					</div>
				</li>	 
			</ul>
			<ul class="action-btns selected-actions pull-right hide"> 
				...
				<li>
					...
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="tag">
						...
						<a href="javascript:;" parent-div="table-records" table="pay_scales" class="dropdown-item align-items-center delete-bulk">
		...
		<div class="row">
				...
				<div class="table-view">
					<div class="table-responsive">
						<table class="table table-hover mb-0 page-table" id="table-sortable">
								...
								<tr> 
									<th class="table-checkbox table_record_checkbox"> 
										<div class="checkbox theme-checkbox ">
											<input type="checkbox" id="colorCheckbox0" class="table_head_checkbox" table="pay_scales"> 
											<label for="colorCheckbox0"></label>
										</div>
									</th>
									<th class="col-title">Title <i class="bx bx-sort"></i></th>
									<th class="col-salary_package">Salary Package<i class="bx bx-sort"></i></th>
									<th class="col-nature_of_jobs_name">JOB Nature <i class="bx bx-sort"></i></th>
									<th class="col-file hide">File <i class="bx bx-sort"></i></th>
									<th class="col-terms hide">Terms <i class="bx bx-sort"></i></th>
									<th class="col-job_resp hide">Job Responsibility <i class="bx bx-sort"></i></th>
							...
							<tbody class="pay_scales table-records">     	
							</tbody>
						</table>
					</div> 
				</div>
								...
								<div class="card-body">
									...
									<div class="col-12">
										<div class="row">
											...
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" checked="checked" value="nature_of_jobs_name" id="tbl-col-checkbox-2" name ="tbl-col-checkbox-2"> 
													<label for="tbl-col-checkbox-2">Job Nature</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" checked="checked" value="salary_package" id="tbl-col-checkbox-3" name ="tbl-col-checkbox-3"> 
													<label for="tbl-col-checkbox-3">Salary Package</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" value="terms" id="tbl-col-checkbox-4" name ="tbl-col-checkbox-4"> 
													<label for="tbl-col-checkbox-4">Terms</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" value="job_resp" id="tbl-col-checkbox-5" name ="tbl-col-checkbox-5"> 
													<label for="tbl-col-checkbox-5">Job Responsibility</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" value="file" id="tbl-col-checkbox-6" name ="tbl-col-checkbox-6"> 
													<label for="tbl-col-checkbox-6">File</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" value="description" id="tbl-col-checkbox-7" name ="tbl-col-checkbox-7"> 
													<label for="tbl-col-checkbox-7">Description</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" checked="checked" value="status" id="tbl-col-checkbox-8" name ="tbl-col-checkbox-8"> 
													<label for="tbl-col-checkbox-8">Status</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" value="added_by" id="tbl-col-checkbox-9" name ="tbl-col-checkbox-9"> 
													<label for="tbl-col-checkbox-9">Added By</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" value="modified_by" id="tbl-col-checkbox-10" name ="tbl-col-checkbox-10"> 
													<label for="tbl-col-checkbox-10">Modified By</label>
												</div>
											</div>

											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" checked="checked" value="date_added" id="tbl-col-checkbox-11" name ="tbl-col-checkbox-11"> 
													<label for="tbl-col-checkbox-11">Date Added</label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" value="date_modification" id="tbl-col-checkbox-12" name ="tbl-col-checkbox-12"> 
													<label for="tbl-col-checkbox-12">Date Modification</label>
												</div>
											</div>
										</div>
									</div>
			...
			<div class="col-3 import-records-sidebar page-sidebar hide">
				<div class="filter-side-content">
					<div class="card shadow-none quill-wrapper">
						<div class="card-header d-flex justify-content-between align-items-center border-bottom px-2 py-1">
							<h3 class="card-title">Import pay_scales </h3>
							<button type="button" class="close close-icon page-sidebar-close">
								<i class="bx bx-x"></i>
							</button>
						</div>
