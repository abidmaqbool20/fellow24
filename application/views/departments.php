...
<?php $records = $this->App_Model->get_departments(); ?>
              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb p-0 mb-0"> 
                    ...
                    <li class="breadcrumb-item active">All Deparments </li>
                  </ol>
                </div>
              </div>
            </div>
				    ...
				    <tbody>
					      	...
					      	?>
					      			<tr class="rec-<?=$value->id ;?>">
								      	...
								      	<td class="text-bold-500"><?php echo $value->short_name;?></td>
								        <td><?php echo $value->description;?></td>
								        <td class="text-bold-500"><?php echo $value->date_added;?></td>
								        <td> 
								        	<div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
								                <input type="checkbox" <?= $checked ;?> class="custom-control-input change-status" table="departments"  id="customSwitchcolor<?=$key ?>" table-id="<?= $value->id;?>">
								        ...
								        <td>
											<div class="dropdown">
							                  ...
							                  <div class="dropdown-menu dropdown-menu-right">
							                    <a class="dropdown-item open-model" data="<?php echo get_json(array('id'=>$value->id,'view'=>'models/form-departments')); ?>" href="javascript:;">Edit</a>
							                    <a class="dropdown-item" href="">View</a>
							                    <a class="dropdown-item delete" data="<?php echo get_json(array('id'=>$value->id,'table'=>'departments')); ?>" href="javascript:;">Delete</a>
							                  </div>
							                </div>
				                        </td>
							        </tr>
