	...
	<div class="row">
		<div class="col-md-6">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h5 class="content-header-title float-left pr-1 mb-0"><i class="bx bxs-group"></i>&nbsp;Nature Of Jobs</h5>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb p-0 mb-0"> 
							<li class="breadcrumb-item"><a href="javascript:;">Home</a> </li>
							<li class="breadcrumb-item"> <i class="bx bx-chevrons-right">  </i> </li> 
							<li class="breadcrumb-item active">All Nature Of Jobs </li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="col-md-6">
			<ul class="action-btns default-actions pull-right">
				...
				<li>
					<button type="button" class="btn btn-icon btn-theme open-model"  data="<?php echo get_json(array('id'=>'0','view'=>'models/form-nature-of-jobs')); ?>"><i class="bx bx-plus"></i></button>
				</li>
				<li>
				...
				<li>
					<button type="button" class="btn btn-icon btn-danger reload-page load-view" data="<?php echo get_json(array('id'=>'0','view'=>'nature-of-jobs-table-view','type'=>'table')); ?>"  title="Refresh Page"><i class="bx bx-refresh"></i></button>
				</li>
				<li>
					<div class="btn-group" role="group" aria-label="Basic example">
						<button type="button" data="<?php echo get_json(array('id'=>'0','view'=>'nature-of-jobs-table-view','type'=>'table')); ?>" class="btn active load-view"><i class="bx bx-table"></i></button>
						<button type="button" data="<?php echo get_json(array('id'=>'0','view'=>'nature-of-jobs-card-view','type'=>'card')); ?>" class="btn load-view"><i class="bx bxs-widget"></i></button>
					</div>
				</li>	 
			</ul>
			<ul class="action-btns selected-actions pull-right hide"> 
				...
				<li>
					...
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="tag">
						<a href="javascript:;" class="dropdown-item align-items-center export-all-data " function="export_all_nature_of_jobs">
							<span class="bullet bullet-success bullet-sm"></span>
							<span> &nbsp;Export All</span>
						</a>
						<a href="javascript:;" function="export_nature_of_jobs" class="dropdown-item align-items-center export-data">
							<span class="bullet bullet-success bullet-sm"></span>
							<span> &nbsp;Export Selected Only</span>
						</a>
						<a href="javascript:;" parent-div="table-records" table="nature_of_jobs" class="dropdown-item align-items-center delete-bulk">
		...
		<div class="row">
				...
				<div class="table-view">
					<div class="table-responsive">
						<table class="table table-hover mb-0 page-table" id="table-sortable">
								...
								<tr> 
									<th class="table-checkbox table_record_checkbox"> 
										<div class="checkbox theme-checkbox ">
											<input type="checkbox" id="colorCheckbox0" class="table_head_checkbox" table="nature_of_jobs"> 
											<label for="colorCheckbox0"></label>
										</div>
									</th>
									<th class="col-title">Title <i class="bx bx-sort"></i></th>
									<th class="col-file">JOB File <i class="bx bx-sort"></i></th>
							...
							<tbody class="nature_of_jobs table-records">     	
							</tbody>
						</table>
					</div> 
				</div>
			...
			<div class="col-3 filter-sidebar page-sidebar hide">
				<div class="filter-side-content">
					<div class="card shadow-none quill-wrapper">
						...
						<!-- form start -->
						<form method="post" autocomplete="off" action="<?= base_url('App/filter_nature_of_jobs'); ?>" enctype="multipart/form-data" class="filter-records">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<fieldset class="form-group">
												...
												<select class="form-control select2 filter-dropdown" name="added_by" id="added_by">
								...
								<div class="card-body">
									...
									<div class="col-12">
										<div class="row">
											...
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
													<input type="checkbox" class="table-column" checked="checked" value="file" id="tbl-col-checkbox-2" name ="tbl-col-checkbox-2"> 
													<label for="tbl-col-checkbox-2">File </label>
												</div>
											</div>
											<div class="col-12 mb-1">
												<div class="checkbox checkbox-success">
			...
			<div class="col-3 import-records-sidebar page-sidebar hide">
				<div class="filter-side-content">
					<div class="card shadow-none quill-wrapper">
						<div class="card-header d-flex justify-content-between align-items-center border-bottom px-2 py-1">
							<h3 class="card-title">Import nature_of_jobs </h3>
							<button type="button" class="close close-icon page-sidebar-close">
								<i class="bx bx-x"></i>
							</button>
						</div>
						<!-- form start -->
						<form method="post" autocomplete="off" action="<?= base_url('App/import_form_nature_of_jobs_csv_file'); ?>" enctype="multipart/form-data" class="import-csv-form">
							<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
							<input type="hidden" name="per_page" id="per_page" value="10" class="per_page">
							<div class="card-content">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-12">
											...
											<fieldset style="text-align: center" class="form-group">
												<button type="button" class="btn btn-theme btn-sm sample-import-file" target="nature_of_jobs.csv"><i class="bx bx-cloud-download"></i> Download Sample</button>
											</fieldset>
										</div>
									</div>
								</div>
