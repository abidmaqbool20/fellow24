...
<?php $records = $this->App_Model->get_payscales(); ?>
	...
	<div class="row">
	    <div class="col-md-6">
	    	<div class="row breadcrumbs-top">
              <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0"><i class="bx bxs-group"></i>&nbsp;Payscales</h5>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb p-0 mb-0"> 
                    <li class="breadcrumb-item"><a href="#">HR</a> </li>
                    <li class="breadcrumb-item"> <i class="bx bx-chevrons-right">  </i> </li> 
                    <li class="breadcrumb-item active">All Payscales </li>
                  </ol>
                </div>
              </div>
            </div>
	    ...
	    <div class="col-md-6">
	    	<ul class="action-btns pull-right">
	    		<li>
	    			<button type="button" class="btn btn-icon btn-primary open-model"  data="<?php echo get_json(array('id'=>'0','view'=>'models/form-payscale')); ?>"><i class="bx bx-plus"></i></button>
	    		</li>
				    ...
				    <tbody>
					      	...
					      	?>
					      			<tr class="rec-<?=$value->id ;?>">
								      	...
								      	<td class="text-bold-500"><?php echo $value->salary_package;?></td>
								        <td><?php echo $value->description;?></td>
								        <td class="text-bold-500"><?php echo $value->date_added;?></td>
								        <td> 
								        	<div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
								                <input type="checkbox" <?= $checked ;?> class="custom-control-input change-status" table="pay_scales"  id="customSwitchcolor<?=$key ?>" table-id="<?= $value->id;?>">
								        ...
								        <td>
											<div class="dropdown">
							                  ...
							                  <div class="dropdown-menu dropdown-menu-right">
							                    <a class="dropdown-item open-model" data="<?php echo get_json(array('id'=>$value->id,'view'=>'models/form-payscale')); ?>" href="javascript:;">Edit</a>
							                    <a class="dropdown-item" href="">View</a>
							                    <a class="dropdown-item delete" data="<?php echo get_json(array('id'=>$value->id,'table'=>'pay_scales')); ?>" href="javascript:;">Delete</a>
							                  </div>
							                </div>
				                        </td>
							        </tr>
